 ...
 *         <li>It provides two methods: {@link #onSuccess(String)} for successful operations and {@link #onError(Throwable)} for handling errors.</li>
 *         <li>The {@link #onSuccess(String)} method is called when the Gemini AI model successfully returns a text response.</li>
 *         <li>The {@link #onError(Throwable)} method is called when an error occurs during the interaction with the Gemini AI model.</li>
